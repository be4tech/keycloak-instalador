...
(function () { return __awaiter(void 0, void 0, void 0, function () {
    ...
    return __generator(this, function (_c) {
        switch (_c.label) {
            ...
            case 1:
                themeType = (_c.sent()).value;
                console.log("Select a page you would like to eject");
                return [4 /*yield*/, (0, cli_select_1.default)({
                        "values": (function () {
                            switch (themeType) {
                                case "login":
                                    return __spreadArray([], __read(generateFtl_1.loginThemePageIds), false);
                                case "account":
                                    return __spreadArray([], __read(generateFtl_1.accountThemePageIds), false);
                            }
            ...
            case 2:
                ...
                _b = [targetFilePath];
                return [4 /*yield*/, (0, promises_1.readFile)((0, path_1.join)((0, getProjectRoot_1.getProjectRoot)(), "src", themeType, "pages", pageBasename))];
