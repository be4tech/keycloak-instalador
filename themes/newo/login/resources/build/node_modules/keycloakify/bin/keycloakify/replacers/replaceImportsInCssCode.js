    ...
    return {
        "cssCodeToPrependInHead": __spreadArray(__spreadArray([
            ...
            return [
                ...
                cssGlobalsToDefine[cssVariableName].replace(new RegExp("url\\(".concat(((_a = buildOptions.urlPathname) !== null && _a !== void 0 ? _a : "/").replace(/\//g, "\\/")), "g"), "url(${url.resourcesPath}/build/")
            ].join(" ");
        })
