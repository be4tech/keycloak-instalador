import type { dom, Evt, NonPostableEvtLike } from "evt/lib/types";
import type { EventTargetLike } from "evt/lib/types";
import type { ObserverConstructor } from "evt/lib/types/Observer";
declare type OneOrMany<T> = T | ArrayLike<T>;
declare type CtxLike<Result> = import("evt/lib/types").CtxLike<Result> & {
